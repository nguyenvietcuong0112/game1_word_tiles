  ...
  void _resetProgress() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Reset Progress?', style: GoogleFonts.fredoka(fontWeight: FontWeight.w900, color: AppColors.textDark, fontSize: 18.sp)),
        content: Text(
          'Are you sure you want to reset all progress for ${_language.toUpperCase()}?',
          style: GoogleFonts.fredoka(color: AppColors.textMuted, fontSize: 14.sp),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx, false),
            child: Text('Cancel', style: GoogleFonts.fredoka(color: AppColors.textMuted, fontWeight: FontWeight.bold, fontSize: 14.sp)),
          ),
          ElevatedButton(
            ...
            child: Text('Reset', style: GoogleFonts.fredoka(fontWeight: FontWeight.bold, fontSize: 14.sp)),
          ),
        ],
      ),
    );
