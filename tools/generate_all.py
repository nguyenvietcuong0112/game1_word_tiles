...
from validate_levels import main as validate_main


def main():
    languages = ["spanish", "portuguese", "russian", "turkish"]
    print("==================================================")
    print("🌍 MASTER LEVEL GENERATOR - 4 REMAINING LANGUAGES")
    ...
    print(f"\n==================================================")
    print(f"🎉 ALL 4 LANGUAGES GENERATED in {time.time() - overall_start:.2f} seconds!")
    print("==================================================")
